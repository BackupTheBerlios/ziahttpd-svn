...
// Last update Wed Dec 07 17:58:36 2005 texane
//
...
bool win32::socket_in::create_client(win32::socket_in::handle_t* hdl,
				     unsigned short distport,
				     const char* distaddr,
				     win32::socket_in::error_t*)
{
  unsigned long addr;
  struct sockaddr_in sa;
  win32::socket_in::handle_t sock;

  if (resolve_readable_inaddr(distaddr, &addr) == false)
    return false;
